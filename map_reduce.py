...
def main():
    ...
    intermediate_results = grid_map(computeFactorial, args, quiet=False, cleanup=False,
                                    max_processes=4, queue='all', temp_dir='/projects/bioracle/jake/pubrunnerPackage/scratch/')
